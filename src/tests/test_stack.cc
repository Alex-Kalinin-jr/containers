...
TEST(stack, init_5) {
    Stack<int> b = Stack<int>{3, 4, 5, 6, 7, 8};
    Stack<int> a{3, 4, 5, 6, 7, 8};
    list_Node<int> c(5);
...
TEST(stack, size1) {
    Stack<int> b = Stack<int>{3, 4, 6, 7, 8, 14};
    ASSERT_EQ(b.size(), 6);
    b.pop();
    ASSERT_EQ(b.size(), 5);
    b.pop();
...
TEST(stack, size4) {
    Stack<int> c(Stack<int>{3, 4, 6, 7, 8, 14});
    ASSERT_EQ(c.size(), 6);
}
